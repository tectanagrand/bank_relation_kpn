<!-- begin breadcrumb -->
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item active">Dashboard OER</li>
	</ol>
<!-- end breadcrumb -->
<h1 class="page-header">OER<small></small></h1>
	...
	<!-- ================== END PAGE LEVEL JS ================== -->	
	<script src="<?php echo base_url()?>/assets/js/dashboard/oer.min.js"></script>
	<!-- ================== END PAGE LEVEL JS ================== -->	
	...
	<script>
		$("#company").change(function(){
			if ($(this).val() != ''){
				...
				/*dropdown post *///  
				$.ajax({
					url : "<?php echo site_url('dashboardoer/ajax_businessunit/')?>/" +  $(this).val(),
					type: "POST",
					dataType: "JSON",
		...
		$(document).ready(function() {
			...
			Dashboard.init();
			$.ajax({
				  url : "<?php echo site_url().'/dashboardoer/ajax_company';?>",
				  type: "POST",
				  dataType: "JSON",
