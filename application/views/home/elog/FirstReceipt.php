...
<script>
    ...
    var table, ACTION, ID, VUUID, VINVOICE_CODE;
                ...
                $('#DtElog').DataTable({
                    ...
                    {"data": "CREATED_AT"},
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if (DEPT == 'IT') {
                                html += '<button class="mb-2 btn btn-danger btn-icon btn-circle btn-sm delete" data-norec="'+data.NO_RECEIPT_DOC+'" data-nopo="'+data.NO_PO+'" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button>';
