...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Upload Pph</li>
</ol>
<h1 class="page-header">Upload Pph</h1>
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a href="#import" data-toggle="tab" class="nav-link">
            <span class="d-sm-none">Tab 2</span>
            <span class="d-sm-block d-none">Upload Pph</span>
        </a>
    </li>
</ul>
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    if (data.ERROR_MSG == null) {
                        html += '<span class="badge badge-pill badge-success">Data Found.</span>';
                    } else {
            ...
            if (fileInput.get(0).files.length) {
                ...
                if (fileSize > maxSize) {
                    ...
                    $.ajax({
                        dataType: "JSON",
                        type: 'POST',
                        url: "<?php echo site_url('Upload/Upload_Pph'); ?>",
                        data: fd,
                        processData: false,
                        contentType: false,
        ...
        if(DtUpload.length <= 0){
            ...
            if (STATUS == false) {
                ...
                $.ajax({
                    dataType: "JSON",
                    type: "POST",
                    url: "<?php echo site_url('Upload/saveUp_PPH'); ?>",
                    data: {
