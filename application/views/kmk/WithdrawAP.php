                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="INV_VALUE" name="INV_VALUE" data-type="currency"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.SUB_BALANCE == null || data.SUB_BALANCE == 0 || data.SUB_BALANCE == '') {
                    ...
                    $('#BALANCE').val(fCurrency(data.SUB_BALANCE));
                }
                // console.log(BATCHID);
                // console.log('success');
...
1
    $('#INV_VALUE').on('change keyup', function () {
        var limit = Number(formatDesimal($('#AMOUNTLIMIT').val()));
        var balance = Number(formatDesimal($('#BALANCE').val()));
        var bilVal = Number(formatDesimal($('#INV_VALUE').val()));
        var rem_limit = balance ? balance : limit ;
            ...
            "ajax": {
                    ...
                    "dataSrc": function(ext) {
                        if (ext.status == 200) {
                            ext.draw = ext.result.data;
                            var total_bilval = 0;
                            for (var i = 0 ; i < ext.draw.length ; i++) {
                                total_bilval += Number(ext.draw[i]['BILLING_VAL']);
                            }
                            AMOUNT = total_bilval;
                            return ext.result.data;
                        } else if (ext.status == 504) {
