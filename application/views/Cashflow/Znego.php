...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Znego</li>
</ol>
                ...
                <table id="DtElog" class="table table-bordered table-striped table-hover dataTable no-footer dtr-inline" width="100%" aria-describedby="DtElog_info" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="text-center" data-orderable="false">Doc No</th>
    ...
    $(document).ready(function () {
        ...
        function loadData(){
            if (!$.fn.DataTable.isDataTable('#DtElog')) {
                $('#DtElog').DataTable({
                    ...
                    "serverSide":true,
                    "ajax": {
                        "url": "<?php echo site_url('Znego/showData') ?>",
                        "datatype": "JSON",
                        "type": "POST",
                        "data": function (d) {
                            d.COMPANY  = COMPANY;
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row, meta) {
                                ...
                                html += '<button class="btn btn-info btn-sm Send" data-id="'+data.ID+'" id="Send" title="Forecast">Forecast</button>';
        ...
        $('body').on('click','#Send',function(){
            ...
            $.ajax({
                dataType: "JSON",
                type: "POST",
                url: "<?php echo site_url('Znego/sendForecast'); ?>",
                data: {
                    CFID: cfid,
                    USERNAME: USERNAME
                },
