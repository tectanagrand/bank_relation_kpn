...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">Upload SAP PO 5</li>
</ol>
<h1 class="page-header">Upload SAP PO 5</h1>
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
        </div>
        <h4 class="panel-title">Upload SAP PO 5</h4>
    </div>
                ...
                if (fileInput.get(0).files.length) {
                    ...
                    if (fileSize > maxSize) {
                        ...
                        $.ajax({
                            dataType: "JSON",
                            type: 'POST',
                            url: "<?php echo site_url('Upload/UploadPO5'); ?>",
                            data: fd,
                            processData: false,
                            contentType: false,
    ...
    var Save = function () {
        if (STATUS == false) {
            ...
            $.ajax({
                dataType: "JSON",
                type: "POST",
                url: "<?php echo site_url('Upload/Save_PO'); ?>",
                data: {
