...
<ol class="breadcrumb pull-right">
    <li class="breadcrumb-item"><a href="javascript:;">Log Forecast</a></li>
    <li class="breadcrumb-item active">Log Forecast</li>
</ol>
<h1 class="page-header">Log Forecast</h1>
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-heading-btn">
            <a href="javascript:;" class="btn btn-xs btn-icon btn-circle btn-default" data-click="panel-expand"><i class="fa fa-expand"></i></a>
        </div>
        <h4 class="panel-title">Log Forecast</h4>
    </div>
    <div class="panel-body">
        ...
        <div class="row ml-0 mr-0 mb-0 mt-2 table-responsive">
            <table id="DtLog" class="table table-striped table-bordered" cellspacing="0" width="100%" aria-describedby="DtUpload_info">
                <thead>
                    <tr role="row">
                        ...
                        <th class="text-center no-sort">Entry By</th>
                        <th class="text-center no-sort">Edited By</th>
                    </tr>
                </thead>
            </table>
        </div>
...
<script>
    ...
    function LoadDataTable() {
        if (!$.fn.DataTable.isDataTable('#DtLog')) {
            $('#DtLog').DataTable({
                "processing": true,
                "bProcessing": true,
                dom: 'Bfrtip',
                ...
                "pageLength": 50,
                "ajax": {
                    "url": "<?php echo site_url('Forecast/showLogForecast') ?>",
                    "type": "POST",
                    "datatype": "JSON",
                    "data": function (d) {
                        d.YEAR = YEAR;
            ...
            $('#DtLog thead th').addClass('text-center');
            table2 = $('#DtLog').DataTable();
            // $("#DtLog_filter").remove();
            // $("#DOCNUMBER").on({
            //     'keyup': function () {
