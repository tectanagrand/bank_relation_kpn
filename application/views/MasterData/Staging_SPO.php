...
<ol class="breadcrumb pull-right">
    <li class="breadcrumb-item"><a href="">Add Spo</a></li>
    <li class="breadcrumb-item active">Add Spo</li>
</ol>
<h1 class="page-header">Add Spo</h1>
<div class="panel panel-success">
    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Add Spo</h4>
    </div>
                ...
                <div class="row form-group">
                    ...
                    <!-- <div class="col-md-3"> -->
                        <!-- <select name="businesunit" id="fbusinessunit" class="form-control"> -->
                            <!-- <option value="">Choose</option> -->
                            <!-- <?php //foreach ($DtBu as $values) { echo '<option value="' . $values->EXTSYSBUSINESSUNITCODE . '">' . $values->EXTSYSBUSINESSUNITCODE .'</option>'; } -->
                            ?>
                        </select> -->
                    <div class="col-md-3">
                    ...
                    <div class="col-md-4 pull-right">
                        <div class="input-group">
                            <button class="btn btn-sm btn-success" onclick="ssearch()" id="submit">Search</button>
                        </div>
                    </div>
                </div>
                </div>
        ...
        function LoadDataTable(){   
            if (!$.fn.DataTable.isDataTable('#insertDtDept')) {
                $('#insertDtDept').DataTable({
                        ...
                        "serverSide":true,
                        "ajax": {
                            "url": "<?php echo site_url('Staging/ShowStagingData') ?>",
                            "datatype": "JSON",
                            "type": "POST",
                            "data": function (d) {
                                d.COMPANY  = COMPANY;
    ...
    var Save = function () {
        $('#loader').addClass('show');
            $.ajax({
                    dataType: "JSON",
                    type: "POST",
                    url: "<?php echo site_url('Staging/saveStaging'); ?>",
                    data: {
                       dtPurch: dtPurch
                       // ACTION: ACTION
                    },
