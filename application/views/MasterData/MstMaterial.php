...
<h1 class="page-header">Master Material</h1>
<div class="panel panel-success">
    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Master Material</h4>
    </div>
            ...
            <form id="FAddEditForm" data-parsley-validate="true" data-parsley-errors-messages-disabled onsubmit="return false">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control" name="EXTSYSTEMCODE" id="EXTSYSTEMCODE" required>
...
<script>
    ...
    function SetDataKosong() {
        $('.panel-title').text('Add Data Material');
        $('#EXTSYSTEMCODE').val('');
        $('#FCCODE').val('');
        $('#FCNAME').val('');
        $('#DESCRIPTION').val('');
    ...
    function SetData(data) {
        $('.panel-title').text('Edit Data Material');
        $('#FCCODE').attr('readonly', true);
        $('#FCCODE').val(data.FCCODE);
        $('#EXTSYSTEMCODE').val(data.EXTSYSTEMCODE);
    ...
    var Save = function () {
        if ($('#FAddEditForm').parsley().validate()) {
            ...
            $.ajax({
                ...
                data: {
                    EXTSYSTEMCODE: $('#EXTSYSTEMCODE').val(),
                    FCCODE: $('#FCCODE').val(),
                    FCNAME: $('#FCNAME').val(),
