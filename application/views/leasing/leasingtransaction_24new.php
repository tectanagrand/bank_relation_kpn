        ...
        <div class="row mb-2">
            <div class="col-md-12">
                <div class="form-row">
                    ...
                    <button type="submit" class="btn btn-primary payAll pull-right mt-4" style="height: fit-content;">Pay All</button>
                ...
                "ajax": {
                    ...
                    "dataSrc": function (ext) {
                        ...
                        if(ext.result.size == 0){
                            ...
                            // });
                            // $('#DUEDATE').datepicker('update', new Date(Y, M, 1));
                    ...
                    {"data": "FCNAME"},
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if(data.TRANSACTIONMETHOD_BY == 'FLAT' || data.TRANSACTIONMETHOD_BY == 'EFEKTIF'){
                                ...
                                var res = data.AMOUNT_AFTER_CONV / data.TOTAL_MONTH;
                                var f   = numFormat(Math.round(res));
                            }
                            else{
