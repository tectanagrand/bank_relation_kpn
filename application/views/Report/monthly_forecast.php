    ...
    $(".xport").click(function(){
        ...
        // .append(table.$('tr').clone())
         .table2excel({
                    ...
                    filename: "Monthly_"+MONTH+'_'+YEAR, // do include extension
                    fileext: ".xls",
   ...
   //                  }
            ...
            "columns": [
                ...
                { "data": null, "className": "text-right", render: function (data, type, row, meta) {
                    ...
                    var numFormat   = $.fn.dataTable.render.number(',', '.', 0).display;
                    var res = intVal(data.PROPW1) + intVal(data.PROPW2) + intVal(data.PROPW3) + intVal(data.PROPW4) + intVal(data.PROPW5);// parseInt(1000000);
                            if(res == "0"){
                                res = "-";
                            }
                            // else if(res < 0.04){
                ...
                { "data": null, "className": "text-right", render: function (data, type, row, meta) {
                    ...
                    var numFormat   = $.fn.dataTable.render.number(',', '.', 0).display;
                    var res = (intVal(data.WAVAR1) + intVal(data.WAVAR2) + intVal(data.WAVAR3) + intVal(data.WAVAR4) + intVal(data.WAVAR5));// parseInt(1000000);
                    if(res == "0"){
                        res = "-";
                    }
                    // else if(res < 0.04){
