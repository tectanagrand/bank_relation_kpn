                    ...
                    <div class="form-row">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select class="form-control" name="WITHINVOICE" id="WITHINVOICE">
                                    <option value="" selected> All</option>
...
<script>
    ...
    var table, DEPARTMENT = "",
        DOCDATETO = "",
        PAIDDATE = "",
        OVERDATE = "", COMPANYGROUP = "", COMPANYSUBGROUP = "", COMPANY = "", WITHINVOICE = "";
    var today = new Date();
