        ...
        <div class="vertical-box-column">
			<div class="alert alert-secondary fade show">
				<div class="tab-content" >
                        ...
                        <button id="myelement" class="btn btn-info btn-sm mb-2" >Fullscreen</button>
   ...
   //                  }
            ...
            "columns": [
                ...
                { "data": null, "className": "text-right", render: function (data, type, row, meta) {
                    ...
                    var numFormat   = $.fn.dataTable.render.number(',', '.', 0).display;
                    var res = (intVal(data.WACTUAL1) + intVal(data.WACTUAL2) + intVal(data.WACTUAL3) + intVal(data.WACTUAL4) + intVal(data.WACTUAL5)/ 1000000);// parseInt(1000000);
                    if(res == "0"){
                                res = "-";
                            }
                            else if(res < 0.04){
    ...
    function loadData() {
            ...
            $.ajax({
                    dataType: "JSON",
                    type: "POST",
                    url: "<?php echo site_url('Cash/getTotalIntercoedit'); ?>",
                    data: {
            ...
            $.ajax({
                    dataType: "JSON",
                    type: "POST",
                    url: "<?php echo site_url('Cash/getInOutIntercoedit'); ?>",
                    data: {
                        MONTH: parseInt(MONTH),
                        YEAR: YEAR,
                        COMPANYGROUP: COMPANYGROUP,
            ...
            $.ajax({
                    ...
                    dataType: "JSON",
                    type: "POST",
                    url: "<?php echo site_url('Cash/getSurplusedit'); ?>",
                    data: {
                        MONTH: parseInt(MONTH),
                        YEAR: YEAR,
                        COMPANYGROUP: COMPANYGROUP,
            ...
            $.ajax({
                        dataType: "JSON",
                        type: 'POST',
                        url: "<?php echo site_url('Cash/ShowDataedited'); ?>",
                        data: {
                                    MONTH: parseInt(MONTH),
                                    YEAR: YEAR,
                                    COMPANYGROUP: COMPANYGROUP,
