...
<h1 class="page-header">E-Log History Docs</h1>
<div class="panel panel-success">
    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title">E-Log History Docs</h4>
    </div>
    <div class="panel-body">
        <?php if (empty($_GET)) { ?>
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <select class="selectpicker form-control mkreadonly" name="COMPANY[]" id="COMPANY" multiple data-live-search="true">
                                <?php
                                    if($this->session->userdata('DEPARTMENT') != 'KOORD-KTU'){
            ...
            <div class="row m-0 table-responsive">
                <table id="DtElog" data-order="[]" class="table table-bordered table-striped table-hover dataTable no-footer dtr-inline" width="100%" aria-describedby="DtElog_info" style="width: 100%;">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="text-center" data-orderable="false">Invoice Code</th>
                            <th class="text-center" data-orderable="false">No PO</th>
                            <th class="text-center" data-orderable="false">Vendor</th>
                            <th class="text-center" data-orderable="false">Currency</th>
                            <th class="text-center" data-orderable="false">Amount</th>
                            <th class="text-center" data-orderable="false">Voucherno</th>
                            <th class="text-center" data-orderable="false">Dpp</th>
                            <th class="text-center" data-orderable="false">Pph</th>
                            <th class="text-center" data-orderable="false">Ppn</th>
                            <th class="text-center" data-orderable="false">Net</th>
                            <th class="text-center" data-orderable="false">Dept</th>
                            <th class="text-center" data-orderable="false">Updated By</th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#PERIOD').datepicker({
         ...
         $("#PERIOD").datepicker().datepicker("setDate", YEAR);
        ...
        function loadData(){
            if (!$.fn.DataTable.isDataTable('#DtElog')) {
                $('#DtElog').DataTable({
                    ...
                    "retrieve": true,
                    "ajax": {
                        "url": "<?php echo site_url('Elog/HistoryDocNew') ?>",
                        "datatype": "JSON",
                        "type": "POST",
                        "data": function (d) {
