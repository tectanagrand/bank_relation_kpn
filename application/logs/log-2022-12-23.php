...
ERROR - 2022-12-23 01:00:01 --> Severity: Notice --> Undefined index: HTTP_HOST /var/www/cashflow/application/config/config.php 26
ERROR - 2022-12-23 01:00:01 --> Severity: Warning --> oci_execute(): ORA-01789: query block has incorrect number of result columns /var/www/cashflow/system/database/drivers/oci8/oci8_driver.php 286
ERROR - 2022-12-23 01:00:01 --> Query error: ORA-01789: query block has incorrect number of result columns - Invalid query: SELECT a.DUEDATE,
                     a.DOCNUMBER,
                     C.COMPANYCODE,
                     S.FCNAME,
                     B.FCNAME AS BUNAME,
