                    ...
                    <div class="row item_form">
                        <div class="col-md-12">
                            ...
                            <div class="custom-file">
                                <input type="file" class="upload-file" name="userfile" id="ATTACHMENT_FILE" onchange="UploadAttachment(this)">
...
<script>
    ...
    $(document).ready(function() {
                    ...
                    "columns": [
                        ...
                        {"data": "AMOUNT","className": "text-center",render: $.fn.dataTable.render.number(',', '.', 2)},
                        {
                            ...
                            render: function(data, type, row, meta) {
                                var html = '';
                                html += '<button class="btn btn-indigo btn-sm upload"  id="UploadAttachmentBtn" title="Receive" data-toggle="modal" data-target="#UploadAttachment">Upload</button>' ;
        ...
        // }
        var table = $('#DtPaymentReq').DataTable();
    ...
    $('#DOWNLOAD').on('click', function() {
        window.open("<?php echo 'http://172.27.7.193/assets/file/'?>" +FILENAME,'_blank');
    })
