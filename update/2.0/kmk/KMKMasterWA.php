                ...
                <div class="panel-body">
                    <form id="FAddEditFormbd" data-parsley-validate="true" data-parsley-errors-messages-disabled="" onsubmit="return false" novalidate="">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="fccode">Payment Bank Account *</label>
                                <input type="text" class="form-control" name="PAYMENT_BANK_ACCOUNT" id="PAYMENT_BANK_ACCOUNT" placeholder="Payment Bank Account" required="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
