...
<div class="panel panel-success">
    ...
    <div class="panel-heading">
        ...
        <h4 class="panel-title">Withdraw Data Time Loan</h4>
    </div>
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a href="#rekeningkoran" data-toggle="tab" class="leasingdata nav-link active">
                    ...
                    <span class="d-sm-block d-none">Withdraw Data Time Loan</span>
                </a>
            </li>
        </ul>
                    ...
                    <form id="FAddEditFormbd" data-parsley-validate="true" data-parsley-errors-messages-disabled="" onsubmit="return false" novalidate="">
                        ...
                        <div class="row mt-2 fileupload-buttonbar">
                            <div class="col-md-4">
                                ...
                                <span class="btn btn-primary fileinput-button m-r-3" id="upload-file">
...
<script>
    ...
    $(document).ready(function () {
        if (getUrlParameter('type') == "edit" || getUrlParameter('type') == "add") {
            ...
            if (getUrlParameter('type') == "add") {
                ...
                if((data.STATUS == '1' || data.STATUS == '0' || data.STATUS == '2') && getUrlParameter('vm') == null){
                    $('#btnSaveMaster').hide();
                    $('.panel-footer #btnSaveMaster').hide();
                    // $('.fileupload-buttonbar').hide(); 
                }
    ...
    function SetData(data) {
        ...
        if(data.AMOUNT_BALANCE == null || data.AMOUNT_BALANCE == 0){
            $('#AMOUNT_BALANCE').val(lastBalance.AMOUNT_BALANCE);    
        }else{
            $('#AMOUNT_BALANCE').val(fCurrency(data.AMOUNT_BALANCE));
        }
        $('#VALUE_DATE').val(moment(data.VALUE_DATE).format('YYYY-MM-DD'));
        ...
        $('#DtUpload').DataTable({
            ...
            {"className": "text-center","data":"LASTUPDATE"},
            {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            if (DELETES == 1) {
                                html += '<button class="btn btn-danger btn-icon btn-circle btn-sm delete" id="btnHapus" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></button>';
                            }
                            return html;
                        }
                    }
