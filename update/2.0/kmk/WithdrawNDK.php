                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                    ...
                                    <select name="SCF_NONDISKONTO_TYPE" id="SCF_NONDISKONTO_TYPE" class="form-control">
                                        <option value="BDPPKS">BPDPKS </option>
...
<script type="text/javascript">
    ...
    function saveWDNDK(elm) {
        if($('#WDNDKDetail').parsley().validate()){
            ...
            var bil_val = formatDesimal($('#BIL_VAL').val());
            if(ID == null || ID == '' || ID == 0){
                toastr.error('ID KOSONG');
                reloadUploadWDNDK();
            }
                                ...
                                success: function (response) {
                                    ...
                                    if (response.status == 200) {
                                        ...
                                        $.ajax({
                                            dataType : 'JSON',
                                            type : 'POST',
                                            url : "<?php echo site_url('Kmk/GetDataWDNDKbyID');?>",
                                            data : {
                                                UUID : DtKmk.UUID,
                                                WD_TYPE : DtKmk.SUB_CREDIT_TYPE
                                            },
                                            success : function(response) {
                                                ...
                                                $('#BALANCE').val(fCurrency(String(currLimit)));
                                                    ...
                                                    var currLimit = data.AMOUNT_BALANCE - (AMOUNT ? AMOUNT : 0) ;
                                                    $('#BALANCE').val(fCurrency(String(currLimit)));    
                                                }
                                            },
